...
export const metadata: Metadata = {
  title: 'Gold Loan Delhi NCR - Instant Cash Against Gold Jewelry | Lowest Interest Rates 2025 | Viraj Jewellers Lajpat Nagar',
  description: 'Get instant gold loan in Delhi NCR with lowest interest rates starting 9.5% p.a. Doorstep service in Lajpat Nagar, South Delhi. Gold loan calculator, quick approval in 15 minutes. Best gold loan rates per gram today at Viraj Jewellers.',
  keywords: [
    // Primary keywords
    'gold loan delhi',
    'gold loan ncr',
  ...
  openGraph: {
    title: 'Gold Loan Delhi NCR - Instant Cash Against Gold | Lowest Rates 2025',
    description: 'Get instant gold loan with lowest interest rates in Delhi NCR. Doorstep service in Lajpat Nagar, South Delhi. Quick 15-min approval, up to 85% gold value. Professional gold loan calculator available.',
    type: 'website',
    locale: 'en_IN',
  ...
  twitter: {
    ...
    description: 'Get instant gold loan with doorstep service in Delhi NCR, Lajpat Nagar. Quick approval, best rates, professional valuation. Calculate your gold loan amount now.',
  ...
  const structuredData = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "description": "Leading gold loan provider in Delhi NCR offering instant cash against gold jewelry with lowest interest rates, doorstep service in Lajpat Nagar, and quick 15-minute approval process.",
        "url": "https://virajjewellers.com",
        "telephone": "+91-9876543210",
        "priceRange": "₹₹₹",
        "address": {
      ...
      },
      {
        ...
        "description": "Professional gold loan services with instant cash disbursement against gold jewelry and ornaments",
        "provider": {
          "@id": "https://virajjewellers.com/#organization"
        },
          ...
          "itemListElement": [
            {
              ...
              "itemOffered": {
                ...
                "description": "Get instant cash against gold jewelry with quick 15-minute approval"
              },
              "priceSpecification": {
            ...
            },
            {
              ...
              "itemOffered": {
                ...
                "description": "Home visit gold loan service for evaluation and processing"
              }
            },
            {
              "@type": "Offer",
              "itemOffered": {
                ...
                "description": "Free online gold loan calculator to estimate loan amount"
              }
            }
          ]
        }
      },
      {
        ...
        "url": "https://virajjewellers.com",
        "name": "Viraj Jewellers - Gold Loan Delhi NCR",
        "description": "Delhi NCR's trusted gold loan provider since 1985. Instant cash against gold with lowest interest rates and doorstep service in Lajpat Nagar.",
        "inLanguage": "en-IN",
        "isPartOf": {
          "@id": "https://virajjewellers.com/#organization"
        },
        "potentialAction": [
          {
            ...
            "target": {
              "@type": "EntryPoint",
              "urlTemplate": "https://virajjewellers.com/search?q={search_term_string}"
            },
  ...
  return (
    <html lang="en-IN" className="scroll-smooth">
      <head>
        ...
        <meta name="title" content="Gold Loan Delhi NCR - Instant Cash Against Gold | Lowest Interest Rates 2025" />
        <meta name="description" content="Get instant gold loan in Delhi NCR with lowest interest rates starting 9.5% p.a. Doorstep service in Lajpat Nagar, South Delhi. Gold loan calculator, quick 15-min approval. Best gold loan rates per gram at Viraj Jewellers." />
        <meta name="keywords" content="gold loan delhi, gold loan ncr, gold loan lajpat nagar, instant gold loan delhi, doorstep gold loan service delhi, gold loan south delhi" />
        ...
        {/* Enhanced OpenGraph */}
        <meta property="og:title" content="Gold Loan Delhi NCR - Instant Cash Against Gold | Lowest Interest Rates 2025" />
        <meta property="og:description" content="Get instant gold loan with lowest interest rates in Delhi NCR. Doorstep service in Lajpat Nagar, South Delhi. Quick 15-min approval, up to 85% gold value. Professional gold loan calculator available." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://virajjewellers.com" />
        <meta property="og:image" content="https://virajjewellers.com/images/gold-loan-delhi-og.jpg" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content="Gold Loan Delhi NCR - Instant Cash Against Gold Jewelry in Lajpat Nagar" />
        <meta property="og:site_name" content="Viraj Jewellers" />
        <meta property="og:locale" content="en_IN" />

        {/* Enhanced Twitter Cards */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Gold Loan Delhi NCR - Instant Cash Against Gold | Lowest Rates" />
        <meta name="twitter:description" content="Get instant gold loan with doorstep service in Delhi NCR, Lajpat Nagar. Quick approval, best rates, professional valuation. Calculate your gold loan amount now." />
        <meta name="twitter:image" content="https://virajjewellers.com/images/gold-loan-delhi-twitter.jpg" />
        ...
        <link rel="alternate" href="https://virajjewellers.com" hrefLang="en-in" />
        <link rel="alternate" href="https://virajjewellers.com/hi" hrefLang="hi-in" />
        <link rel="alternate" href="https://virajjewellers.com/mr" hrefLang="mr-in" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Instant cash loans against gold jewelry with lowest interest rates and doorstep service in Mumbai",
              "provider": {
                "@type": "Organization",
                "name": "Viraj Jewellers",
                "url": "https://virajjewellers.com"
      ...
      <body className={`${inter.variable} ${playfair.variable} font-sans antialiased bg-gradient-to-br from-amber-50 to-yellow-50`}>
        {/* Skip Navigation for Accessibility */}
        <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 bg-yellow-600 text-white px-4 py-2 rounded z-50">
